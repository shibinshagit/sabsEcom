...
// // // product page not aptimized old 
...
//   // Only show spin button if auth is initialized AND user is not authenticated
//   const shouldShowSpinButton = authInitialized && !isAuthenticated && !showSpinner
...
//         {/* Show Spin Button ONLY for unauthenticated users */}
//         {shouldShowSpinButton && (
