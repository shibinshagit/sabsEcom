...
interface CurrencyContextType {
    ...
    formatPriceWithSmallDecimals: (priceAed?: number, priceInr?: number, defaultCurrency?: Currency) => React.ReactNode
...
const getCurrencySymbol = (currency: Currency): string | JSX.Element => {
    switch (currency) {
        case "AED":
            return (
                <svg
...
const formatPriceWithSmallDecimals = (
  ...
  return (
    <span className="flex items-center gap-1">
      ...
      {/* Price with small decimals but same baseline */}
